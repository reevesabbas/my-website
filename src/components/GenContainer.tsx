...
const GenContainer: React.FC<Props> = ({children, title, icon, id, ...rest}) => {
  return (
      <section id={id} className='md:max-w-[1250px] w-full h-fit flex mx-auto'>
        <div className='md:w-[1000px] sm:w-full h-full flex mx-auto dark:bg-lightestBlue bg-darkPurple dark:bg-opacity-[0.065] bg-opacity-10 rounded-lg sm:p-10 px-3 py-7'>
